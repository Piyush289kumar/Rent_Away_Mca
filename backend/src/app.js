...
import galleryActionRoutes from "./routes/gallery.action.routes.js";
import galleryUserRoutes from "./routes/gallery.user.routes.js";
...
app.use(
  cors({
    origin: (origin, callback) => {
      ...
      return callback(null, true); // ⬅️ IMPORTANT: allow instead of crash
    },
    credentials: false, // ✅ JWT based auth, NOT cookies
...
app.use(`${routePrefix}/gallery`, galleryActionRoutes);
app.use(`${routePrefix}/gallery`, galleryUserRoutes);
