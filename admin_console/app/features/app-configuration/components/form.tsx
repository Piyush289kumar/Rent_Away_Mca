...
export default function AppConfigurationForm({
  ...
  // ✅ Prefill Data
  useEffect(() => {
    if (data?.app_config_data) {
      const c = data.app_config_data;
      setValues({
        appName: c.appName || "",
        email: c.email || "",
        phoneNumber: c.phoneNumber || "",
        companyAddress:
          c.companyAddress?.length > 0
            ? c.companyAddress
        ...
        googleAppStoreLink: c.googleAppStoreLink || "",
        appleAppStoreLink: c.appleAppStoreLink || "",
      });
    }
  }, [data]);
  ...
  const handleAddressChange = (
    ...
    const updated = [...values.companyAddress];
